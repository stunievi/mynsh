...
public enum MongoUtil {
    ...
    public MongoCollection<Document> getCollection(String collName) {
        return getCollection("databaseName", collName);
    }
    ...
    public void close() {
        ...
        System.out.println("===============MongoUtil关闭连接========================");
...
//         //删除数据库
//         MongoUtil.instance.dropDB("testDBName");

        //删除表
        //MongoUtil2.instance.dropCollection(dbName, collName);

//         //修改数据
//         String id = "58caa6041320c814f4520129";
//         Document newdoc = new Document();
//         newdoc.put("name", "龚lei");
//         MongoUtil.instance.updateById(coll, id, newdoc);

        //统计表
        //System.out.println(MongoUtil.instance.getCount(coll));
