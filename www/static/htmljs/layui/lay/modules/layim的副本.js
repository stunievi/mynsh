...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        return b && t.close(b.attr("times")), x && x.hide(), j.mine = j.mine || {}, t.open({
            ...
            offset: "rb",
            resize: !1,
            content: '<img onerror="onFaceError(this)" src="' + (j.mine.avatar || layui.cache.dir + "css/pc/layim/skin/logo.jpg") + '"><span>' + (i || j.base.title || "我的LayIM") + "</span>",
            ...
            var a = x.find(".layui-layim-search"), e = x.find("#layui-layim-search"), t = a.find("input"),
                n = function (i) {
                    ...
                    if ("" === a) ei.tab(0 | ei.tab.index); else {
                        ...
                        if (n.length > 0) for (var u = 0; u < n.length; u++) o += '<li layim-event="chat" data-type="' + n[u].type + '" data-index="' + n[u].index + '" data-list="' + n[u].list + '"> <!-- <img onerror="onFaceError(this)" src="' + n[u].avatar + '"> --> <span>' + (n[u].username || n[u].groupname || "佚名") + "</span><p>" + (n[u].remark || n[u].sign || "") + "</p></li>"; else o = '<li class="layim-null">无搜索结果</li>';
                        e.html(o), ei.tab(3)
                    }
                };
