...
public class LFSService {
    ...
    public String login(String username, String password){
        String str = OkHttpUtil.getForHeader2(buildUrl("/apiLogin.action"), C.newMap("username",username,"password",password), null);
        return str;
    ...
    public String createDir(String sessionId, String pid, String name){
        //sessionId="JSESSIONID=6198D3421FFB1333354719E9DDAABDD5; sid_linkapp=d225b78b-66fd-43ad-8f71-60122efbcfee;";
