...
//
//        final List<Lang.TypeConverter> converters = C.newList();
//        converters.add(
//                new Lang.TypeConverter() {
//                    @Override
//                    public Object convert(Object o) {
//                        if (o instanceof JSONArray) {
//                            return $.map(o).withConverter(converters).to(BasicDBList.class);
//                        } else if (o instanceof JSONObject) {
//                            return $.map(o).withConverter(converters).to(DBObject.class);
//                        }
//                        return o;
//                    }
//                }
...
//        Document document = $.map(object2).withConverter(converters).to(Document.class);
//
