...
public class UserController {
    ...
    private final IQuartersDao quartersDao;
    ...
    @Autowired
    public UserController(IUserDao userDao, IRoleDao roleDao, IQuartersDao quartersDao, SystemConfigCache cache, EntityManager entityManager, UserService userService, FastFileStorageClient storageClient) {
    ...
    public Result<User> add(
            @Validated @RequestBody UserAddRequeest edit
