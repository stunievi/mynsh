...
//    List<Message> getAllBySessionOrderBySendTimeDesc(MessageSession session, Pageable pageable);
    ...
    List<Message> findUser2UserRecentMessages(long fromId, long toId, long messageId, Pageable pageable);
    ...
    List<Message> findUser2UserRecentMessages(long fromId,long toId,Pageable pageable);
    ...
    Optional<Message> findContainsFileMessage(long uid, long fileId);
