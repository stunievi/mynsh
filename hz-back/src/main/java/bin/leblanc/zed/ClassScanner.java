...
//                            }
//                            // 如果前半部分和定义的包名相同
//                            if (nodeName.startsWith(packageDirName)) {
//                                int idx = nodeName.lastIndexOf('/');
//                                // 如果以"/"结尾 是一个包
//                                if (idx != -1) {
//                                    // 获取包名 把"/"替换成"."
//                                    packageName = nodeName.substring(0, idx).replace('/', '.');
//                                }
//                                // 如果可以迭代下去 并且是一个包
//                                if ((idx != -1) || recursive) {
//                                    // 如果是一个.class文件 而且不是目录
//                                    if (nodeName.endsWith(".class") && !entry.isDirectory()) {
//                                        // 去掉后面的".class" 获取真正的类名
//                                        String className = nodeName.substring(
//                                                packageName.length() + 1, nodeName.length() - 6);
//                                        try {
//                                            // 添加到classes
