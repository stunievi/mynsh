    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        (0, _avalon.component)("checkbox", {
            ...
            defaults: {
                ...
                onAtLeastChange: function onAtLeastChange() {
        ...
        (0, _avalon.component)("ziliaoNode", {
            ...
            defaults: {
                ...
                addField: function addField(type) {
                    ...
                    for (var i in _avalon2['default'].components[type].defaults.data) {
                        data[i] = _avalon2['default'].components[type].defaults.data[i];
                    }
